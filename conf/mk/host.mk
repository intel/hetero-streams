...
HOST_x200_CARD_STARTUP_SERIALIZED = hStreams_x200_card.cpp
ABS_HOST_x200_CARD_STARTUP_SERIALIZED = $(HOST_ONTHEFLY_SRC_DIR)hStreams_x200_card.cpp

HOST_ONTHEFLY_FILES = \
	$(HOST_x100_CARD_STARTUP_SERIALIZED) \
	$(HOST_x200_CARD_STARTUP_SERIALIZED)
...
$(ABS_HOST_x200_CARD_STARTUP_SERIALIZED): $(x200_CARD_EXE_TARGET)
	$(dir_create)
	python $(INCBIN) $< $@ x200_card_startup
