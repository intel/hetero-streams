...
cd %1
icl /Qmic -D_GLIBCXX_USE_CXX11_ABI=0 -UHSTR_SOURCE -I../include -I./include -I"%MKLROOT%/include" -qopenmp -pthread -rdynamic -O3 -ggdb -o %2\hstreams_sink_x100.so hStreams_COIWrapper_sink.cpp hStreams_MKLWrapper.cpp hStreams_sink.cpp hStreams_exceptions.cpp hStreams_app_api_sink.cpp hStreams_internal_vars_common.cpp hStreams_internal_vars_sink.cpp hStreams_common.cpp hStreams_locks.cpp hStreams_Logger.cpp hStreams_helpers_common.cpp
rem # Cross-compilation for x200 card is under investigation
icl /Qmic -D_GLIBCXX_USE_CXX11_ABI=0 -UHSTR_SOURCE -I../include -I./include -I"%MKLROOT%/include" -qopenmp -pthread -rdynamic -O3 -ggdb -o %2\hstreams_sink_x200.so hStreams_COIWrapper_sink.cpp hStreams_MKLWrapper.cpp hStreams_sink.cpp hStreams_exceptions.cpp hStreams_app_api_sink.cpp hStreams_internal_vars_common.cpp hStreams_internal_vars_sink.cpp hStreams_common.cpp hStreams_locks.cpp hStreams_Logger.cpp hStreams_helpers_common.cpp
