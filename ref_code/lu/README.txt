...
icpc -c /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/lu/tiled_host/lu_tile.cpp -o /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/lu/tiled_host/lu_tile.source.o -Wall -Werror-all -fPIC -DNDEBUG -O3 -diag-disable 13368 -diag-disable 15527 -I/localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/common -I/usr/include/hStreams  -mkl -qopenmp
...
[INFO] In order to build against the library and headers from the repository, append in_repo=1 to make arguments
[INFO] Building release version. In order to build debug version, append CFG=DEBUG to make arguments
icpc -c /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/lu/tiled_hstreams/lu_tile_hstreams.cpp -o /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/lu/tiled_hstreams/lu_tile_hstreams.source.o -Wall -Werror-all -fPIC -DNDEBUG -O3 -diag-disable 13368 -diag-disable 15527 -I/localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/common -I/usr/include/hStreams  -mkl -qopenmp
icpc -c /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/common/dtime.cpp -o /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/common/dtime.source.o -Wall -Werror-all -fPIC -DNDEBUG -O3 -diag-disable 13368 -diag-disable 15527 -I/localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/common -I/usr/include/hStreams  -mkl -qopenmp
...
icpc -mmic /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/common/hStreams_custom_kernels_sink_host.x100-sink.o -o /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/../bin/x100-card/lu_sink_1.so   -mkl -shared -Wl,-soname,lu_sink_1.so -qopenmp
