...
icpc -c [...]/temp_ref_code/hstreams/ref_code/lu/tiled_host/lu_tile.cpp -o [...]/temp_ref_code/hstreams/ref_code/lu/tiled_host/lu_tile.source.o -Wall -Werror-all -fPIC -DNDEBUG -O3 -diag-disable 13368 -diag-disable 15527 -I[...]/temp_ref_code/hstreams/ref_code/common -I/usr/include/hStreams  -mkl -qopenmp
...
icpc [...]/temp_ref_code/hstreams/ref_code/lu/tiled_host/lu_tile.source.o [...]/temp_ref_code/hstreams/ref_code/common/dtime.source.o [...]/temp_ref_code/hstreams/ref_code/common/matrices_generator.source.o -o [...]/temp_ref_code/hstreams/ref_code/../bin/host/lu_tiled_host   -mkl -qopenmp
...
[INFO] In order to build against the library and headers from the repository, append in_repo=1 to make arguments
[INFO] Building release version. In order to build debug version, append CFG=DEBUG to make arguments
icpc -c [...]/temp_ref_code/hstreams/ref_code/lu/tiled_hstreams/lu_tile_hstreams.cpp -o [...]/temp_ref_code/hstreams/ref_code/lu/tiled_hstreams/lu_tile_hstreams.source.o -Wall -Werror-all -fPIC -DNDEBUG -O3 -diag-disable 13368 -diag-disable 15527 -I[...]/temp_ref_code/hstreams/ref_code/common -I/usr/include/hStreams  -mkl -qopenmp
icpc -c [...]/temp_ref_code/hstreams/ref_code/common/dtime.cpp -o [...]/temp_ref_code/hstreams/ref_code/common/dtime.source.o -Wall -Werror-all -fPIC -DNDEBUG -O3 -diag-disable 13368 -diag-disable 15527 -I[...]/temp_ref_code/hstreams/ref_code/common -I/usr/include/hStreams  -mkl -qopenmp
...
icpc -c [...]/temp_ref_code/hstreams/ref_code/common/matrices_generator.cpp -o [...]/temp_ref_code/hstreams/ref_code/common/matrices_generator.source.o -Wall -Werror-all -fPIC -DNDEBUG -O3 -diag-disable 13368 -diag-disable 15527 -I[...]/temp_ref_code/hstreams/ref_code/common -I/usr/include/hStreams  -mkl -qopenmp
icpc [...]/temp_ref_code/hstreams/ref_code/lu/tiled_hstreams/lu_tile_hstreams.source.o [...]/temp_ref_code/hstreams/ref_code/common/dtime.source.o [...]/temp_ref_code/hstreams/ref_code/common/hStreams_custom.source.o [...]/temp_ref_code/hstreams/ref_code/common/matrices_generator.source.o -o [...]/temp_ref_code/hstreams/ref_code/../bin/host/lu_tiled_hstreams   -mkl -lhstreams_source -qopenmp
icpc -mmic -c [...]/temp_ref_code/hstreams/ref_code/common/hStreams_custom_kernels_sink_host.cpp -o [...]/temp_ref_code/hstreams/ref_code/common/hStreams_custom_kernels_sink_host.x100-sink.o -Wall -Werror-all -fPIC -DNDEBUG -O3 -diag-disable 13368 -diag-disable 15527 -I[...]/temp_ref_code/hstreams/ref_code/common -I/usr/include/hStreams  -mkl -qopenmp
icpc -mmic [...]/temp_ref_code/hstreams/ref_code/common/hStreams_custom_kernels_sink_host.x100-sink.o -o [...]/temp_ref_code/hstreams/ref_code/../bin/x100-card/lu_sink_1.so   -mkl -shared -Wl,-soname,lu_sink_1.so -qopenmp
