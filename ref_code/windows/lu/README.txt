...
This file is for use of the lu apps on Windows only.

For information on Linux, please see the README.txt file in ../../lu.
...
HOW TO INTERPRET RESULTS OF THE LU REFERENCE CODE
...
cd %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\lu
...
3a If you have v 15.0 of Composer XE installed open the solution file stored in %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\lu\tiled_host\tiled_host.sln
3b If you have v 14.0 of Composer XE installed open the solution file stored in %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\lu\tiled_host\tiled_host_14.0.sln
4. Make sure the configuration selected is Debug/x64.
5. Build / Build solution.

Should build, and populate the directory with the following files:

%INTEL_MPSS_HOST_SDK%\tutorials\windows\lu\tiled_host>dir x64\Debug

 Directory of %INTEL_MPSS_HOST_SDK%\tutorials\windows\lu\tiled_host\x64\Debug
...
2. Install either version 14.0 or 15.0 of the Intel Composer XE compiler for windows.
3. Bring up MSVS 2012, and in MSVS:
3a If you have v 15.0 of Composer XE installed open the solution file stored in %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\lu\tiled_hstreams\tiled_hstreams.sln
3b If you have v 14.0 of Composer XE installed open the solution file stored in %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\lu\tiled_hstreams\tiled_hstreams_14.0.sln
4. Make sure the configuration selected is Debug/x64.
5. Build / Build solution.

Should build, and populate the directory with the following files:

 Directory of C:\Program Files\Intel\MPSS\sdk\tutorials\hstreams\windows\lu\tiled_hstreams\x64\Debug
...
6a. cd to the ... sdk\tutorials\hstreams\windows\lu\tiled_hstreams directory
6b. .\buildcs.bat
...
C:\Program Files\Intel\MPSS\sdk\tutorials\hstreams\windows\lu\tiled_hstreams>dir
 lu_sink_1.so
 Volume in drive C has no label.
 Volume Serial Number is 1AEE-4BBA

 Directory of C:\Program Files\Intel\MPSS\sdk\tutorials\hstreams\windows\lu\tiled_hstreams
...
cd %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\lu\tiled_host
.\runit.bat 
...
cd %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\lu\tiled_hstreams
.\runit.bat 

The system should respond with output similar to the content recorded in the Linux README (../../lu/README.txt).
