...
This file is for use of the io_perf on Windows only.

For information on Linux, please see the README.txt file in ../../io_perf.
...
Bring up DOS command window:
   ...
   - In Windows 7 or Windows Server 2008 go to:
       For version '2013 SP1' of the Intel Composer XE compiler:
       ...
       For version '2015' of the Intel Composer XE compiler:
...
cd %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\io_perf
--------------------------------------------------------------
...
2. Bring up MSVS 2012, and open the solution file stored in %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\io_perf\io_perf.sln
3. Make sure the configuration selected is Debug/x64.
4. Build / Build solution.

Should build, and populate the directory with the following files:

%INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\io_perf>dir x64\Debug

 Directory of %INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\io_perf\x64\Debug
...
%INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\io_perf>.\run_io_perf.bat

%INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\io_perf>set HSTREAMS_SINK=C:\Program Files\Intel\MPSS\\k1om-mpss-linux\usr\lib64

%INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\io_perf>set "SINK_LD_LIBRARY_PATH=C:\Program Files\Intel\MPSS\\k1om-mpss-linux\usr\lib64;C:\Progra
m Files (x86)\Intel\Composer XE 2013 SP1\compiler\lib\mic;C:\Program Files (x86)
\Intel\Composer XE 2013 SP1\mkl\lib\mic"

%INTEL_MPSS_HOST_SDK%\tutorials\hstreams\windows\io_perf>.\x64\Debu
g\io_perf.exe
>>init
>>create bufs
