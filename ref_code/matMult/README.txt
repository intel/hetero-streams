...
. /opt/mpss_toolchains/composer/composer_xe_2015/bin/compilervars.sh intel64
or
...
1. Examine the run_matMult.sh and ../common/setEnv.sh scripts.
...
2. Run the run_matMult.sh script:
