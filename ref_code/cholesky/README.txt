...
icpc -mmic /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/common/hStreams_custom_kernels_sink.x100-sink.o -o /localdisk/work/wwasko/hstreams_workspace/hstreams/ref_code/../bin/x100-card/cholesky_sink_1.so   -mkl -shared -Wl,-soname,cholesky_sink_1.so -openmp
