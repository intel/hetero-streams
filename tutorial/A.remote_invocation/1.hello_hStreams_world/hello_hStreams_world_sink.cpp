...
// Optional header and macro, for convenience only
...
void hello_hStreams_world_sink_1(uint64_t a_double_value_converted_to_uint)
{
    ...
    value = converter.Get(); // C++ convenience function
    value = *(double *)&a_double_value_converted_to_uint; // A non-standard alternative
